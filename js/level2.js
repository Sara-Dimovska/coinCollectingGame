...
var playStateLvl2 = {
    sozdadiSvet: function() {
        ...
        this.paricka = game.add.sprite(475,140,'paricka');       
    ...
    create: function(){ // rezervirana Phaser funkcija
        ...
        this.igrac = game.add.sprite(455,420,'igrac');       
        this.igrac.frame = 1;
    ...
    update: function(){ // rezervirana Phaser funkcija
       ...
       /* 
        var novZivot_niza = [5,30,60,90];
        
        if(novZivot_niza.includes(game.global.rezultat)){          
           novZivot =  game.add.sprite(485,370,'zivot');
           game.physics.arcade.enable(novZivot);           
        }
        
        game.physics.arcade.overlap(novZivot,this.igrac, this.zemiNovZivot, null, this);*/
    },
    
   /*
    zemiNovZivot: function(novZivot,igrac){  
        novZivot.kill();
        
       // this.zemaParickaZvuk.play();            
        //var k = game.global.brojZivoti;
       // zivoti.push(novZivot.reset(zivotPocetokX + k *(zivotDolzina + prostor_PomegjuZivoti),zivotPocetokY));         
    },*/
    ...
    obnoviPozicijaParicka: function() {
        ...
        var pozicijaParicka = [ 
            {x: 275, y: 290},  {x: 675, y: 292},
            {x: 370, y: 540},  {x: 570, y: 540},
            {x: 200, y: 790},  {x: 800, y: 790}
        ];
